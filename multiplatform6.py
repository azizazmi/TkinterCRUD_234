...
# Fungsi untuk memperbarui data dalam tabel berdasarkan id
...
# Fungsi untuk menghapus data dalam tabel berdasarkan id
...
# Fungsi untuk memperbarui data baru di form GUI
def update():
    try:
...
# Fungsi untuk menghapus data baru di form GUI
def delete():
    try:
        if not selected_record_id.get():
...
# Fungsi untuk mengisi input dari data table yang dipilih
...
#Tombol aksi untuk Add, Update, dan Delete
